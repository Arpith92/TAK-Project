...
# ---- Referral list from DB (10% discount)
...
# ---- Bhasmarathi section (outside table)
...
# ---- Helpers for Code master lookups
...
record = {
    ...
    "package_cost": int(total_package),  # (legacy) used by old views
    "bhasmarathi_types": bhas_desc_str,  # (legacy) descriptive
    # final text blob
